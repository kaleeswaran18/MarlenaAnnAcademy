  ...
  return (
    ...
    >
      <div className="container">
        {/* ── LOGO ── */}
        <NavLink className="logo" to="/" aria-label="Marlena Ann Academy — Home">
          <span className="logo-photo-wrap">
            <img
              src="https://res.cloudinary.com/dbrymrvqu/image/upload/v1786964789/SaveClip.App_683653501_18581664907012408_108727681488591770_n__1___1_-removebg-preview_ifnis0.png"
              alt=""
          ...
          <span className="logo-text-wrap">
            ...
            <span className="logo-text">Marlena Ann Academy</span>
          </span>
        </NavLink>
