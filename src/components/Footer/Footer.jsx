      ...
      <div className="container">
          ...
          <div className="footer-column footer-contact">
            ...
            <ul>
              <li>
                ...
                <span>18,sentamil 11th street parasakthinagar avaniyapuram, Madurai - 625021</span>
              </li>
              <li>
              ...
              <li>
                ...
                <a href="mailto:info@marlenaannacademy.in">info@marlenaannacademy.in</a>
              </li>
            </ul>
          </div>
        </motion.div>
        ...
        <div className="footer-bottom">
          <span className="footer-bottom-copy">
            © 2026 <span>Marlena Ann academy</span>. All Rights Reserved.
          </span>
