...
const stories = [
  {
    name: "MARLENA ANN",
    role: " Director of Evergreen Christmas Center and a distinguished leader in public service",
    quote:
      "Healthcare, education, employment, and economic opportunity are the foundations of a progressive society. My mission is to empower every youngster in Tamil Nadu with the knowledge, skills, opportunities, and support they need to learn, grow, become self-reliant, and build a successful future with dignity. Through responsible leadership and inclusive development, I aspire to create a stronger and more prosperous Tamil Nadu for every citizen.",
    highlight: "Healthcare • Education • Employment",
    image: "https://res.cloudinary.com/dbrymrvqu/image/upload/v1786956705/WhatsApp_Image_2026-08-17_at_1.54.57_PM_wsslzi.jpg",
  },
  {
      ...
      <div className="container">
        ...
        <div className="stories-hero">
          ...
          >
            ...
            <h2 className="stories-hero-highlight">
  Think Beyond the Impossible
</h2>

<p className="stories-hero-desc">
  Marlena Ann firmly believes that the youth are the driving force behind
  Tamil Nadu's future. Through entrepreneurship, education, employment,
  skill development, and public welfare initiatives, she is committed to
  creating opportunities for every young individual to learn, grow, become
  self-reliant, and contribute to a stronger and more prosperous society.
</p>
